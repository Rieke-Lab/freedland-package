...
classdef flashImages < edu.washington.riekelab.protocols.RiekeLabStageProtocol
    properties
        ...
        includeReducedImages    = true;     % include reduced image flashes (see settings in code)
    ...
    properties (Hidden)
        ...
        rectificationBiasType = symphonyui.core.PropertyType('char', 'row', {'center','surround','full-field','all','ignore','diverse'}) 
        imageNo
        frame
        imageDatabase
        tracker
        ...
        function prepareRun(obj)
            ...
            if strcmp(obj.cellPolarity,'on')
                ...
                elseif strcmp(obj.rectificationBias,'ignore')
                    % Images that produce wide spectrum of spike behaviors
                ...
                elseif strcmp(obj.rectificationBias,'diverse')
                    % Images with evenly-distributed diversity of center- and surround-luminances
            ...
            if obj.includeReducedImages == true
                ...
                settings.meanDisks    = 1;                           % Make disk a linear-equivalent projection
                settings.naturalDisks = 2;
                settings.slices       = 1;
                settings.sliceDisks   = [];                          % Apply slicing to disk

    ...
    methods
        ...
        function prepareRun(obj)
            ...
            obj.showFigure('edu.washington.riekelab.freedland.figures.rfFlashFigureRatio',...
                ...
                'stimTime',obj.stimTime,'tailTime',obj.tailTime,'xval','presetNo'); 
        ...
        function tf = shouldContinuePreparingEpochs(obj)
            if obj.addRawMean == true
                tf = obj.numEpochsPrepared < obj.numberOfAverages * (length(obj.maskPresets)+1);
            else
        ...
        function tf = shouldContinueRun(obj)
            if obj.addRawMean == true
                tf = obj.numEpochsCompleted < obj.numberOfAverages * (length(obj.maskPresets)+1);
            else

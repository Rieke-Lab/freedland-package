...
[Ntraces,L] = size(D);
Dhighpass = edu.washington.riekelab.freedland.utils.highPassFilter(D,HighPassCut_spikes,SampleInterval);
...
for i=1:Ntraces
    ...
    %get peaks
    [peaks,peak_times] = edu.washington.riekelab.freedland.utils.getPeaks(trace,1); %positive peaks

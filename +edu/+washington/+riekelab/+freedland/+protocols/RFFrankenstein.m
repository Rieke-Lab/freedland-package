...
% By J. Freedland, 2019.
classdef RFFrankenstein < edu.washington.riekelab.protocols.RiekeLabStageProtocol
    ...
    methods
        ...
        function prepareRun(obj)
            ...
            % Downsample from 200Hz to 60Hz
            downsampledTime = round(1:200/60:length(obj.timeTraj));
            obj.xTraj = obj.xTraj(downsampledTime);
            obj.yTraj = obj.yTraj(downsampledTime);
            obj.timeTraj = obj.timeTraj(downsampledTime);
            ...
            for a = 1:size(unwImageFrames,4)
                wimageFrames(:,:,1,a) = unwImageFrames(:,:,1,a) .* RFFilterVH;
            end

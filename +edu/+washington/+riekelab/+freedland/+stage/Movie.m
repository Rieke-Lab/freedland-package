classdef Movie < stage.core.Stimulus
    % A movie player stimulus capable of playing movie structures from MATLAB
    % Input: 4-D matrix: N x M x 1 x F matrix, where F = frames.
    % Frame rate is dictated by monitor capacity.
    ...
    properties (Access = private)
        movieData       % Movie data (N x M x 1 x F)
    ...
    methods
        ...
        function init(obj, canvas)
            ...
            obj.player = VideoPlayer(obj.movieData);
